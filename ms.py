...
if sel == "CLM":
    ...
    # Auto-generate as soon as consolidated file is available and platform is selected
    if st.session_state.consolidated_bytes and st.session_state.dashboard_platform != sel:
